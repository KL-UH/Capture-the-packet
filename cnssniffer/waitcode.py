...
tk.Label(root, text='SNIFF-THE-PACKET', font = "Helventica 24 bold").pack()
...
tk.Button(button_frame, text='Start Sniffing', command = start_button, width = 15, font= "Helventica 16 bold").pack(side=tk.LEFT)
tk.Button(button_frame, text='Stop Sniffing', command = stop_button, width = 15, font= "Helventica 16 bold").pack(side=tk.LEFT)
